...
const Add = () => {
  const porturl = "http://localhost:4000"
  ...
  const onSubmitHandler = async (event)=>{
    ...
    const response = await axios.post(`${porturl}/api/food/add`,formData);
      ...
      <form onSubmit={onSubmitHandler} className='flex-col' >
        ...
        <div className="add-category-price flex-col">
            ...
            <div className="add-price flex-col">
                <p>Product Price</p>
                <input onChange={onChangeHandler} value={data.price} name='price' type="Number" />
            </div>
        </div>
